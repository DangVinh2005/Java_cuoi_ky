...
public class Login extends javax.swing.JPanel {
                ...
                Service.getInstance().getClient().emit("register", data.toJsonObject(), new Ack() {
                    ...
                    public void call(Object... os) {
                        if (os.length > 0) {
                            ...
                            System.out.println("Registration response received from server: " + ms.getMessage());
                        }
                    }
                });
            }
    ...
    private void initComponents() {
        ...
        pic = new App.com.vinh.swing.PictureBox();
        jLabel2 = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        jPanel1 = new javax.swing.JPanel();
        jPanel2 = new javax.swing.JPanel();
        slide = new App.com.vinh.swing.PanelSlide();

        setBackground(new java.awt.Color(255, 255, 255));

        pic.setImage(new javax.swing.ImageIcon(getClass().getResource("login_image.png"))); // NOI18N
    ...
    private App.com.vinh.swing.PictureBox pic;
    private App.com.vinh.swing.PanelSlide slide;
