...
import App.com.vinh.app.MessageType;
import App.com.vinh.emoji.Emogi;
import App.com.vinh.emoji.Model_Emoji;
import App.com.vinh.event.PublicEvent;
import App.com.vinh.main.Main;
...
import App.com.vinh.swing.WrapLayout;
...
public class Panel_More extends javax.swing.JPanel {
    ...
    private JButton getButtonFile() {
        OptionButton cmd = new OptionButton();
        cmd.setIcon(new ImageIcon(getClass().getResource("link.png")));
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JFileChooser ch = new JFileChooser();
