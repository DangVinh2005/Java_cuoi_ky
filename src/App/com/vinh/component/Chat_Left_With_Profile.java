...
public class Chat_Left_With_Profile extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        IaImage = new App.com.vinh.swing.ImageAvatar();
        txt = new App.com.vinh.component.Chat_Item();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/vinh/icon/testing/dog.jpg"))); // NOI18N
    ...
    private App.com.vinh.swing.ImageAvatar IaImage;
    private javax.swing.JLayeredPane jLayeredPane1;
    private App.com.vinh.component.Chat_Item txt;
