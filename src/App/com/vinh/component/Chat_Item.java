...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/vinh/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/vinh/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new App.com.vinh.swing.JIMSendTextPane();
    ...
    private App.com.vinh.swing.JIMSendTextPane txt;
